...
body{background-image:linear-gradient(rgba(7,19,33,.64),rgba(7,19,33,.70)),url('${BG_SOURCE}');background-size:cover;background-position:center top;background-attachment:fixed;background-repeat:no-repeat}
body::before{content:"";position:fixed;inset:0;background:url('${BG_SOURCE}') center top/cover no-repeat;opacity:.13;pointer-events:none;z-index:0}
